...
describe("TokenPrice", () => {
  test(".fromBaseTokenAndQuoteAmount", () => {
    ...
    expect(ethPriceInUsdc.toDecimal().toString()).toEqual(new Decimal(4000).toString());
  ...
  test(".invert", () => {
    ...
    expect(usdcPriceInEth.toDecimal().toString()).toEqual(new Decimal(0.00025).toString());
